...
function TopSkills() {
  ...
  return (
    <div className="container basis-1/4 bg-cardBgColor rounded-md shadow-lg pt-3 px-6 space-y-3">
      ...
      <div className="flex justify-center flex-wrap space-x-2 font-opensans">
        {topSkills.map((skill, index) => (
          <div
            key={index}
            className="flex flex-col justify-between items-center bg-lightPurpleColor rounded-3xl w-24 h-20 px-2 py-2.5 mb-2 hover:rotate-12 hover:scale-110 hover:bg-violet-400 transition duration-300 "
          >
            <span className="text-center text-sm leading-4 font-medium text-textColor">
              {skill.skill}
            </span>
